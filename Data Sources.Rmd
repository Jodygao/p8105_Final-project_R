...
# Data Cleaning:
We first import three files by creating the data import function (import_df) that reads the data from an .XPT file format. Then we merge the three datasets (P_BMX.XPT, P_DEMO.XPT, P_PAQ.XPT, P_DBQ.XPT) using a full join on the ‘SEQN’ column. Then, we select the specific column SEQN, RIAGENDR, RIDAGEYR, DMDMARTZ, INDFMPIR, RIDRETH3, DMDEDUC2, PAD680, BMXBMI, DBD900, and DBD910.

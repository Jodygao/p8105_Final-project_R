...
overall <- read_csv("2022-overall-prevalence.csv", show_col_types = FALSE)
asian <- read_csv("2022-asian.csv", show_col_types = FALSE)
black <- read_csv("2022-black.csv", show_col_types = FALSE)
white <- read_csv("2022-white.csv", show_col_types = FALSE)
hispanic <- read_csv("2022-hispanic.csv", show_col_types = FALSE)

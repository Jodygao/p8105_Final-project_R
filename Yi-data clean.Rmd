...
ggplot(obesity_sedentary_activity_filtered, aes(x = sedentary_activity)) +
  geom_histogram(binwidth = 10, fill = "pink", color = "lightblue") +
...
kable(fast_food_summary, format = "markdown", caption = "Fast Food Summary")
```
...
kable(frozen_food_summary, format = "markdown", caption = "Frozen Food Summary")
```
